    ...
    <div class="main-content">
        <div class="container">
            <div class="form-card">
                ...
                <form action="<?php echo URLROOT; ?>/products/edit/<?php echo $data['product']->product_id; ?>" method="post"
                    enctype="multipart/form-data">

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Product Name</label>
                            <input type="text" name="name" class="form-control" value="<?php echo $data['product']->name; ?>"
                                required>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control"
                            rows="3"><?php echo $data['product']->description; ?></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" name="mrp" class="form-control"
                                value="<?php echo $data['product']->mrp; ?>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label text-success fw-bold">Selling Price</label>
                            <input type="number" step="0.01" name="selling_price" class="form-control"
                                value="<?php echo $data['product']->selling_price; ?>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Unit Value</label>
                            <input type="text" name="unit_value" class="form-control"
                                value="<?php echo $data['product']->unit_value; ?>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="stock_qty" class="form-control"
                                value="<?php echo $data['product']->stock_qty; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-2 mb-3">
                            <?php if (!empty($data['product']->image)): ?>
                                <img src="<?php echo URLROOT; ?>/assets/products/<?php echo $data['product']->image; ?>" width="60"
